    ...
    <div className="flex-1 px-3 py-1 flex flex-col min-h-0">
      ...
      boxShadow: "0 8px 32px -8px rgba(0,0,0,0.6), 0 4px 16px -4px rgba(0,0,0,0.4)"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3">
          <div className="text-white font-bold text-[15px]" style={{
      ...
      <div className="flex flex-wrap gap-2 mt-4 justify-center">
        ...
        return <span key={tag} className={cn("rounded-full backdrop-blur-sm border", isEmphasis ? "px-3 py-1 text-[10px] text-white/95 bg-white/[0.12] border-white/[0.18] font-medium" : "px-2.5 py-0.5 text-[10px] text-white/80 bg-white/[0.08] border-white/[0.12]")}>
              {tag}
            </span>;
      })}
      </div>
      ...
      <div className="mt-3 space-y-0.5">
        ...
        return <div key={show.rank} className="py-1.5 px-3 rounded-lg bg-white/[0.02] border border-white/[0.04]" style={{
          opacity,
          filter: blur
        }}>
