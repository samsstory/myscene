      ...
      <AnimatePresence>
        {viewMode === 'rankings' && searchBarHidden && !attentionFilterActive && !floatingSearchOpen && (
          <motion.button
            ...
            className="fixed bottom-[7.5rem] right-6 z-40 w-12 h-12 rounded-full bg-white/[0.08] backdrop-blur-md border border-white/[0.16] flex items-center justify-center shadow-lg hover:bg-white/[0.14] hover:border-white/[0.22] transition-colors active:scale-95"
          >
