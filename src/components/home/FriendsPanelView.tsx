    ...
    return (
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] uppercase tracking-[0.18em] font-semibold text-white/30">
            My Scene This Week
          </span>
        </div>
        <div className="flex items-center gap-3 py-3">
          <div className="w-10 h-10 rounded-full bg-white/[0.06] border border-white/[0.10] flex items-center justify-center flex-shrink-0">
            <Users className="h-5 w-5 text-white/25" />
          </div>
          <p className="text-sm text-white/40">Follow friends to see who's going to shows this week</p>
        </div>
      </div>
    );
  }
